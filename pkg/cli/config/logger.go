...
func (x *Logger) Flags() []cli.Flag {
	return []cli.Flag{
		&cli.StringFlag{
			...
			Category:    "logging",
			Aliases:     []string{"l"},
			Sources:     cli.EnvVars("HECATONCHEIRES_LOG_LEVEL"),
		...
		&cli.StringFlag{
			...
			Category:    "logging",
			Aliases:     []string{"f"},
			Sources:     cli.EnvVars("HECATONCHEIRES_LOG_FORMAT"),
		...
		&cli.StringFlag{
			...
			Category:    "logging",
			Aliases:     []string{"o"},
			Sources:     cli.EnvVars("HECATONCHEIRES_LOG_OUTPUT"),
		...
		&cli.BoolFlag{
			...
			Sources:     cli.EnvVars("HECATONCHEIRES_LOG_QUIET"),
			Destination: &x.quiet,
		},
		&cli.BoolFlag{
			Name:        "log-stacktrace",
			...
			Sources:     cli.EnvVars("HECATONCHEIRES_LOG_STACKTRACE"),
