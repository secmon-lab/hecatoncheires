...
// TickHookHandler exposes POST /hooks/tick. The endpoint is intentionally
// unauthenticated: the assumption is that the deployment fronts it with
// IAP / internal-network policy. Body is ignored.
//
